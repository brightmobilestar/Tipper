...
internal extension Array {
    ...
    */
    func isContain <T: Equatable> (items: T...) -> Bool {
    ...
    */
    func uniqueBy <T: Equatable> (call: (Element) -> (T)) -> [Element] {
        ...
        for item in self {
            ...
            if !uniqueItems.isContain(callResult) {
