...
// Example: KNAlertView().showSuccess(self, title: "Test", subTitle: "Value").close()
class KNAlertViewResponder {
    let alertview: KNAlertView
    
    // Initialisation and Title/Subtitle/Close functions
    init(alertview: KNAlertView) {
...
// The Main Class
class KNAlertView: UIViewController {
	...
	func addButton(title:String, target:AnyObject, selector:Selector)->KNButton {
		...
		private func addButton(title:String)->KNButton {
		// Update view height
		kWindowHeight += 45.0
		// Add button
		let btn = KNButton()
	...
	func showSuccess(vc:UIViewController, title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
	...
	func showError(vc:UIViewController, title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
	...
	func showNotice(vc:UIViewController, title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
		return showTitle(vc, title: title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Notice)
	}
	
	// showWarning(view, title, subTitle)
	func showWarning(vc:UIViewController, title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
		return showTitle(vc, title: title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Warning)
	}
	
	// showInfo(view, title, subTitle)
	func showInfo(vc:UIViewController, title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
		return showTitle(vc, title: title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Info)
	}
	
	func showEdit(vc:UIViewController, title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
		return showTitle(vc, title: title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Edit)
	}
	
    // showTitle(view, title, subTitle, style)
	func showTitle(vc:UIViewController, title: String, subTitle: String, style: KNAlertViewStyle, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> KNAlertViewResponder {
        return showTitle(vc, title: title, subTitle: subTitle, duration:duration, completeText:closeButtonTitle, style: style)
    }
    
    // showTitle(view, title, subTitle, duration, style)
    func showTitle(vc:UIViewController, title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: KNAlertViewStyle) -> KNAlertViewResponder {
        view.alpha = 0
        ...
        switch style {
			case .Success:
				...
				iconImage = KNAlertViewStyleKit.imageOfCheckmark
				
			case .Error:
				viewColor = UIColorFromRGB(0xC1272D)
				iconImage = KNAlertViewStyleKit.imageOfCross
				
			case .Notice:
				viewColor = UIColorFromRGB(0x727375)
				iconImage = KNAlertViewStyleKit.imageOfNotice
				
			case .Warning:
				viewColor = UIColorFromRGB(0xFFD110)
				iconImage = KNAlertViewStyleKit.imageOfWarning
				
			case .Info:
				viewColor = UIColorFromRGB(0x2866BF)
				iconImage = KNAlertViewStyleKit.imageOfInfo
            
			case .Edit:
				viewColor = UIColorFromRGB(0xA429FF)
				iconImage = KNAlertViewStyleKit.imageOfEdit
        }
		...
		for btn in buttons {
			...
			if style == KNAlertViewStyle.Warning {
        ...
        // Chainable objects
        return KNAlertViewResponder(alertview: self)
    }
...
class KNAlertViewStyleKit : NSObject {
    ...
    if (Cache.imageOfCheckmark != nil) {
        ...
        KNAlertViewStyleKit.drawCheckmark()
    ...
    if (Cache.imageOfNotice != nil) {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), false, 0)
        KNAlertViewStyleKit.drawNotice()
    ...
    if (Cache.imageOfWarning != nil) {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), false, 0)
        KNAlertViewStyleKit.drawWarning()
